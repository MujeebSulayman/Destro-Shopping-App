		...
		<div className='grid grid-cols-1 py-20 md:grid-cols-2 w-full'>
			<div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
				<div className='flex items-center gap-2 justify-center bg-gray-400 px-2 py-1 rounded-full'>
					<p className='text-base text-gray-100 font-normal'>Bike Delivery</p>
				...
				<p className='text-[2.5rem] lg:text-[4.6rem] font-extrabold tracking-wide text-headingColor'>
					...
					<span className='text-blue-400 text-[3rem] lg:text-[4.8rem]'>
						Ibadan City
					</span>
				</p>
				...
				<button
					type='button'
					className='bg-blue-400 w-auto px-4 py-2 rounded-lg mb-12 lg:mb-0 hover:shadow-lg hover:bg-blue-800 transition-all ease-in-out duration-100 text-white'>
					Order now
				</button>
			</div>
			<div className='flex justify-center items-center relative'>
				<img
					src={cheff}
					alt='Hero-bg'
					className='flex items-center justify-center lg:h-600 h-300 lg:w-auto'
				/>
			</div>
		</div>
	);
